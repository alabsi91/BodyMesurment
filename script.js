...
addToHomePop = () => $("#addToHomePop").slideToggle(100);
bmipop = () => $("#bmipop").slideToggle(100);
bmrpop = () => $("#bmrpop").slideToggle(100);
whtrpop = () => $("#whtrpop").slideToggle(100);
ibwpop = () => $("#ibwpop").slideToggle(100);
bfppop = () => $("#bfppop").slideToggle(100);
lbmpop = () => $("#lbmpop").slideToggle(100);
tbwpop = () => $("#tbwpop").slideToggle(100);
neckpop = () => $("#neckpop").slideToggle(100);
waistpop = () => $("#waistpop").slideToggle(100);
hippop = () => $("#hippop").slideToggle(100);
agealert = () => $("#agealert").slideToggle(100);
weightalert = () => $("#weightalert").slideToggle(100);
heightalert = () => $("#heightalert").slideToggle(100);
neckalert = () => $("#neckalert").slideToggle(100);
waistalert = () => $("#waistalert").slideToggle(100);
hipalert = () => $("#hipalert").slideToggle(100);
skippop = () => $("#skippop").slideToggle(100);